...
class CouponCodesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coupon_code" do
    assert_difference('CouponCode.count') do
      post coupon_codes_url, params: { coupon_code: { allow_multiple_usage: @coupon_code.allow_multiple_usage, begin_at: @coupon_code.begin_at, code: @coupon_code.code, discount: @coupon_code.discount, end_at: @coupon_code.end_at } }
    end
  ...
  test "should update coupon_code" do
    patch coupon_code_url(@coupon_code), params: { coupon_code: { allow_multiple_usage: @coupon_code.allow_multiple_usage, begin_at: @coupon_code.begin_at, code: @coupon_code.code, discount: @coupon_code.discount, end_at: @coupon_code.end_at } }
